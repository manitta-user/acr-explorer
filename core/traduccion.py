...
_PROC = {
    ...
    "lung": "pulmón", "or": "o",
    # --- términos faltantes detectados en QA de terminología (frases primero) ---
    "external beam radiation therapy": "radioterapia externa",
    "nuclear medicine": "medicina nuclear", "shear wave": "onda de corte",
    "median arcuate ligament": "ligamento arcuato medio",
    "surgery": "cirugía", "surgical": "quirúrgico", "resection": "resección",
    "ligament": "ligamento", "release": "liberación", "arcuate": "arcuato",
    "median": "medio", "prostaglandin": "prostaglandina", "therapies": "terapias",
    "duct": "conducto", "chemoembolization": "quimioembolización",
    "radioembolization": "radioembolización", "transhepatic": "transhepático",
    "transjugular": "transyugular", "retroperitoneum": "de retroperitoneo",
    "ovaries": "de ovarios", "adnexa": "de anexos", "hips": "de caderas",
    "calcaneus": "de calcáneo", "mandible": "de mandíbula", "months": "meses",
    "month": "mes", "biophysical": "biofísico", "anatomy": "anatomía",
    "detailed": "detallado", "tubal": "tubárico", "petrosal": "petroso",
    "voiding": "miccional", "assessment": "evaluación", "profile": "perfil",
    "measures": "medidas", "supportive": "de soporte",
    "microphlebectomy": "microflebectomía", "maneuvers": "maniobras",
    "defecation": "defecación", "modification": "modificación",
    "dietary": "dietético", "medical": "médico", "gastroesophageal": "gastroesofágico",
    "reflux": "reflujo", "augmentation": "aumento",
    "plethysmography": "pletismografía", "pulse": "pulso", "volume": "volumen",
    "recording": "registro", "subtraction": "sustracción", "complete": "completo",
    "decubitus": "decúbito", "weightbearing": "carga", "intravenous": "intravenoso",
    "inspiration": "inspiración", "expiration": "espiración", "midline": "línea media",
    "in": "en", "wave": "onda", "shear": "corte", "formation": "formación",
...
_CLIN = {
    ...
    "axillary adenopathy": "adenopatía axilar",
    "lymphadenopathy": "adenopatía",
    "adenopathy": "adenopatía",
    # --- frecuentes detectados en QA de terminología ---
    "past medical history": "antecedentes médicos",
    "medical history": "antecedentes médicos",
    "ped": "pediátrico", "neg": "negativa", "eval": "evaluación",
    "medical": "médico", "meals": "comidas", "likely": "probable",
    "showing": "que muestra", "near": "cerca de",
    "infection": "infección",
